...
1. systemd 사용자 서비스를 TB1과 WSL에 배포하고 재시작 복구를 검증한다.
2. 전체 테스트와 문서 링크를 검토한다.
3. 목적별 커밋을 만들고 Draft PR을 생성한다.
4. Phase 5에서 SLAM·Nav2 웹 명령 경계를 설계한다.
