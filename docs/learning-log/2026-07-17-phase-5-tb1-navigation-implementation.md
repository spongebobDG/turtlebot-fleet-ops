...
2026-07-18에 다른 PC 기준선을 다시 측정해 준비 시간을 `45~90분`, 합계를
`3시간 50분~6시간 5분`, buffer 포함 시험 창을 `6시간 45분`으로 갱신했다. 최신 산정은
[운영 절차의 예상 소요시간](../setup/tb1-navigation.md#예상-소요시간)과
[현재 PC 기준선](2026-07-18-current-pc-baseline.md)을 따른다.
