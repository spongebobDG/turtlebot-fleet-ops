...
## 13. Robot Agent와 Safety Watchdog의 차이
...
수신 시각으로 하도록 설계했습니다. 현재 WSL에서 29개 테스트를 통과했습니다.”
...
고려해 NaN 대신 sentinel과 valid flag를 사용했습니다. 정책과 ROS graph를 포함한 29개
